...
public abstract class BinaryExpression<E extends Number> extends AbstractExpression<E>
{
	...
	public void setParent(Expression<E> parent) throws IllegalArgumentException
	{
		if(parent instanceof TerminalExpression) {
			throw new IllegalArgumentException("TerminalExpression<E> can't have children");
		}
		if(super.contains(parent)) {
			throw new IllegalArgumentException("parent shouldn't be contained in self expression");
		}
		this.parent = parent;
	}
	...
	public boolean contains(Expression<E> expr)
	{
		...
		return left.contains(expr) || right.contains(expr) || super.contains(expr);
	}
